...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-10 p-4" style="min-height: 550px; background-color: #EEEBE3;">
                ...
                ?>
                <!-- INÍCIO FORM STEP 1-->
                <form name="signupForm" class="needs-validation" action="../controller/adm_regClient.php" id="signupForm" validate onsubmit="return validaForm(this);" method="post">
                ...
                <input type="hidden" name="cod" value="<?=$_COOKIE[$cookie_name];?>">
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="date" class="form-control"  name="nasc"  id="nasc" placeholder="Nascimento" aria-describedby="validationTooltipNascimentoPrepend">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control"  name="cpf" id="cpf" placeholder="CPF" value="">
                            <div class="valid-tooltip">
                                Tudo certo!
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="radio"  name="genero" id="genero" value="masc" checked>
                            <label class="form-check-label" for="genero">
                                Masculino
                            </label>
                            <input type="radio" name="genero" id="genero" value="fem">
                            <label class="form-check-label" for="genero">
                                Feminino
                            </label>
                        </div>
                ...
                <form name="signupForm2" class="needs-validation" action="../controller/adm_regClient.php" id="signupForm2" validate onsubmit="return validaForm(this);" method="post">
                <input type="hidden" name="step" value="1">
                <input type="hidden" name="cod" value="<?php print $_COOKIE[$cookie_name];?>">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="nome">Primeiro nome</label>
                            <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="<?php print $_POST["nome"];?>"  >
                            <div class="valid-tooltip">
                                Tudo certo!
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="sobrenome">Sobrenome</label>
                            <input type="text" class="form-control" id="sobrenome"  name="sobrenome"  placeholder="Sobrenome" value="<?php print $_POST["sobrenome"];?>"  >
                            <div class="valid-tooltip">
                                Tudo certo!
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control"  name="nasc"  id="nasc" placeholder="Nascimento" aria-describedby="validationTooltipNascimentoPrepend" value="<?php print $_POST["nasc"];?>"  >
                                <div class="invalid-tooltip">
                                    Por favor, insira a data de seu nascimento.
                                </div>
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="email1">E-mail</label>
                            <input type="email" class="form-control"  name="email1"  id="email1" placeholder="E-mail" value="<?php print $_POST["email1"];?>" >
                            <div class="invalid-tooltip">
                                Por favor, informe seu e-mail.
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="email2">E-mail</label>
                            <input type="email" class="form-control"  name="email2"  id="email2" placeholder="E-mail" value="<?php print $_POST["email2"];?>" >
                            <div class="invalid-tooltip">
                                Por favor, informe seu e-mail.
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="password">Senha</label>
                            <input type="password" class="form-control"  name="password"  id="password" placeholder="Senha"  value="<<?php print $_POST["password"];?>">
                            <div class="invalid-tooltip">
                                Por favor, informe sua senha.
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="cpf">CPF</label>
                            <input type="number" class="form-control"  name="cpf" id="cpf" placeholder="CPF" value="<?php print $_POST["cpf"]; ?>"   >
                            <div class="valid-tooltip">
                                Tudo certo!
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="genero">Gênero</label><br>
                            <input type="radio"  name="genero" id="genero" value="masc" <?php if($_POST['genero'] == "masc"){ print "checked";}  ?>>
                            <label class="form-check-label" for="genero">
                                Masculino
                            </label>
                            <input type="radio" id="genero" value="fem" <?php if($_POST['genero'] == "fem"){ print "checked"; } ?>>
                            <label class="form-check-label" for="genero">
                                Feminino
                            </label>
                        </div>
    ...
    /*
		function validaForm(ff){
			...
			if(ff.nome.value == "" || ff.nome.value == null || ff.nome.value.lenght < 3){
				alert("Por Favor, insira seu nome.***");
				ff.nome.focus();
				return false;
			}

			if(signupForm.sobrenome.value == "" || signupForm.sobrenome.value == null || signupForm.sobrenome.value.lenght .< 3){
				alert("Por Favor, insira seu sobrenome.");
				signupForm.sobrenome.focus();
				return false;
			}
			
			if(signupForm.nasc.value == "" || signupForm.nasc.value == null){
				alert("Por Favor, insira sua data de nascimento.");
				signupForm.nasc.focus();
				return false;
			}
			
			if(signupForm.email1.value == "" || signupForm.email1.value == null || signupForm.email1.value.lenght < 10){
				alert("Por Favor, insira seu email.");
				signupForm.email1.focus();
				return false;
			}
			
			if(signupForm.email2.value == "" || signupForm.email2.value == null || signupForm.email2.value.lenght < 10
			|| signupForm.email2.value != signupForm.email2.value){
				alert("Por Favor, confira se o seu email foi escrito corretamente.");
				signupForm.email2.focus();
				return false;
			}
			
			if(signupForm.password.value == "" || signupForm.password.value == null){
				alert("Por Favor, insira sua senha.");
				signupForm.password.focus();
				return false;
			}else if(signupForm.password.value.lenght < 8){
				alert("Sua senha deve ter no mínimo 8 caracteres.");
				signupForm.password.focus();
				return false;
			}
			
			if(signupForm.cpf.value == "" || signupForm.cpf.value == null || signupForm.cpf.value.lenght < 11){
				alert("Por Favor, insira seu CPF.");
				signupForm.cpf.focus();
				return false;
			}
		}
        */
